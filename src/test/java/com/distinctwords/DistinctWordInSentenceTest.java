 ...
 * Test 5 - numbers 
 * Test 6 - words and numbers
 * Test 7 - same words mixed with capitals
 * 
 */
public class DistinctWordInSentenceTest extends TestCase {

	@Test
	public void testingNormalSentence() {
		String testString = "This is a statement, and so is this.";
		Map tallyMap = DistinctWordInSentence.validateSentanceAndTally(testString);
